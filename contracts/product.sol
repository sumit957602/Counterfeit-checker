...
contract product {
    ...
    // Function for the manufacturer to sell a product
    ...
    // Function for the seller to sell a product
    ...
    // Function to query the list of products associated with a seller
    ...
    // Function to query the list of sellers associated with a manufacturer
